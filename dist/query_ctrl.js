...
System.register(['app/plugins/sdk'], function (_export, _context) {
  ...
  var QueryCtrl, _createClass, AmplitudeQueryCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('AmplitudeQueryCtrl', AmplitudeQueryCtrl = function (_QueryCtrl) {
      ...
      _export('AmplitudeQueryCtrl', AmplitudeQueryCtrl);
